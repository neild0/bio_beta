...
import PicturesWall from "./components/UploadGene";
...
function GenomicsPage() {
    const navigateToGeneResultsPage = () => {
        history.push("/gene_results");
    };
    return (
        <div
            css={css`
      ...
      {""} */}
        ...
        `}
          ...
          `}
                    href="/gene_results"
                >
                    <img src={nextLogo} width={45} onClick={navigateToGeneResultsPage}></img>
                </a>
                &nbsp;
